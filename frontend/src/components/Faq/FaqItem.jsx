...
const FaqItem = ({item}) =>{
    ...
    return <div className='p-3 lg:p-5 rounded-[12px] border border-solid border-[#d9dce2] mb-5 cursor-pointer'>
        <div className='flex items-center justify-between gap-5 ' onClick={toggleAccordion}>
            ...
            <div className={`${isOpen && "bg-primaryColor text-white border-none" } w-7 h-7 lg:h-8 lg:w-8 border border-solid border-[#141F21] rounded flex items-center justify-center `}>
