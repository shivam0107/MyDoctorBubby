  ...
  return (<>
   ...
   <section className='hero__section pt-[60px] 2xl:h-[800px]'>
      ...
      <div className="container">
        ...
        <div className='py-[30px] px-5'>
            ...
            <div className='mt-[30px] '>
              ...
              <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>World-class care for everyone.Our health system offers unmatched, expert healthcare.From the lab to the clinic.</p>
               
              <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#18u1A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
    ...
    <About/> 
      ...
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
             ...
             {/* ==============feature img============== */}
             <div className='relative z-10 xl:w-[770px] flex justify-end dmt-[50px] lg:mt-0'>
                ...
                <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md-bottom-[100px] md-left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                  ...
                  <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px] ">
                    ...
                    <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] '>Neelesh Singh</h4>
                  </div>
      ...
      {/* ================= our greater doctors start================= */}

      <section>
        <div className="container">
          <div className='xl:w-[470px] mx-auto'>
            <h2 className='heading text-center'>Top rated Doctors</h2>
            <p className='text__para text-center'>
              world-class care for everyone. Our health system offers unmatched, expert health care.
            </p>
          </div>
